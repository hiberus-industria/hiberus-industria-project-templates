...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CreateUserRequestDto"/> class.
    /// </summary>
    /// <param name="username">The username of the user.</param>
    /// <param name="firstName">The first name of the user.</param>
    /// <param name="lastName">The last name of the user.</param>
    /// <param name="email">The email address of the user.</param>
    public CreateUserRequestDto(string username, string firstName, string lastName, string? email)
    {
    ...
    /// </summary>
    /// <param name="defaultPassword">The default password to set for the user.</param>
    /// <returns>A <see cref="UserRepresentation"/> object with the properties set from this instance.</returns>
    public UserRepresentation ToUserRepresentation(string defaultPassword)
    {
